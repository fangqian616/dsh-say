 ...
 *
 * Windows and POSIX both, because the venv layout differs: `Scripts/python.exe`
 * against `bin/python`. Returning the one that matches the platform keeps callers
 * from having to know which host they are on.
 */
